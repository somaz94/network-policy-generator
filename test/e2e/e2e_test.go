...
import (
	...
	"github.com/somaz94/network-policy-generator/test/utils"
)

// namespace where the project is deployed in
const namespace = "network-policy-generator-system"

// serviceAccountName created for the project
const serviceAccountName = "network-policy-generator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "network-policy-generator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "network-policy-generator-metrics-binding"
