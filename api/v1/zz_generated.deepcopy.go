...
func (in *NetworkPolicyGeneratorSpec) DeepCopyInto(out *NetworkPolicyGeneratorSpec) {
	*out = *in
	...
	if in.CIDRRules != nil {
		in, out := &in.CIDRRules, &out.CIDRRules
...
func (in *NetworkPolicyGeneratorStatus) DeepCopyInto(out *NetworkPolicyGeneratorStatus) {
	*out = *in
	...
	if in.SuggestedNamespaces != nil {
		in, out := &in.SuggestedNamespaces, &out.SuggestedNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SuggestedRules != nil {
		in, out := &in.SuggestedRules, &out.SuggestedRules
		*out = make([]SuggestedRule, len(*in))
		copy(*out, *in)
	}
	...
	if in.PolicyDiff != nil {
		in, out := &in.PolicyDiff, &out.PolicyDiff
		*out = make([]PolicyDiffEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PolicyDiffEntry) DeepCopyInto(out *PolicyDiffEntry) {
	*out = *in
	in.Timestamp.DeepCopyInto(&out.Timestamp)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicyDiffEntry.
func (in *PolicyDiffEntry) DeepCopy() *PolicyDiffEntry {
	if in == nil {
		return nil
	}
	out := new(PolicyDiffEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SuggestedRule) DeepCopyInto(out *SuggestedRule) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SuggestedRule.
func (in *SuggestedRule) DeepCopy() *SuggestedRule {
	if in == nil {
		return nil
	}
	out := new(SuggestedRule)
	in.DeepCopyInto(out)
	return out
}
